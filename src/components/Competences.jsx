          ...
          >
            <MDBCarouselInner >
                  ...
                  <MDBRow>
                    <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "150px" }}
                      />
                      <h5 className="font-weight-bold my-3 ">HTML.5</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "150px" }}
                      />
                      <h5 className="font-weight-bold my-3">CSS.3</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="3" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "150px" }}
                      />
                      <h5 className="font-weight-bold my-3">JavaScript</h5>
                    </MDBCol>
                  ...
                  <MDBRow>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">JQuery</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">MDB React</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Bootstrap</h5>
                    </MDBCol>
                  ...
                  <MDBRow>
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Node.JS</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">MongoDB</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Express</h5>
                    </MDBCol>
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        tag="img"
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Handlebars</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">REST</h5>
                    </MDBCol>
                  ...
                  <MDBRow className="mb-3">
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">VSCode</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Postman</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Git</h5>
                    </MDBCol>
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        tag="img"
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Gitkraken</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">GitHub Desktop</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Cmder</h5>
                    </MDBCol>
                  </MDBRow>
                  ...
                  <MDBRow>
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Heroku</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Trello</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Adobe Photoshop</h5>
                    </MDBCol>
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        tag="img"
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Microsoft Office</h5>
                    </MDBCol>
                    ...
                    <MDBCol lg="2" md="6" className="mb-lg-0 mb-5">
                      <img
                        ...
                        style={{ width: "130px" }}
                      />
                      <h5 className="font-weight-bold my-3">Slack</h5>
                    </MDBCol>
                  </MDBRow>
                </MDBCarouselItem>
              ...
              <View  className="my-5">
                ...
                <View className="row">
                  <View className="px-5 col-12">
                    <h4 className="mt-5 mb-3">Le contenu est référençable</h4>
                    <p  className="text-justify grey-text ">
                  ...
                  <View className="px-5 col-12">
                    <h4 className="mt-5 mb-3">ReactJS est très rapide</h4>
                    <p  className="text-justify grey-text ">
                  ...
                  <View className="px-5 col-12 ">
                    <h4 className="mt-5 mb-3">Les composants sont le futur du développement web</h4>
                    <p  className="text-justify grey-text " >
